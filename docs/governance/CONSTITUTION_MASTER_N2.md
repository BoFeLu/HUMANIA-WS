# CONSTITUCIÓN CANÓNICA DE HUMANIA (N2)
...
- **Determinismo Operativo:** Salidas reproducibles y enraizadas en el repositorio canónico.
- **Ley Vital de Preservación (19-Feb):** Prohibido el borrado o movimiento sin validación profunda de contenido. Salvar contenido > Estética.

## 2. GOBERNANZA Y CONTROL
- **Punto de Entrada Único:** Todo comando operativo vía \humania_run.ps1\.
- **Guardia-Primero:** Ejecución gated por \humania_guard.ps1\.
- **Taxonomía de Datos (LOG_005):**
    - **Nivel 1 (CRÍTICO):** Legal vigente y procedimientos operativos.
